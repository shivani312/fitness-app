        ...
        <div className="left-section width--30 bg--white p--20">
            ...
            <div className="user-info flex justify-content--around p--10 mb--20">
                <div className="info flex align-items--center justify-content--center flex--column">
                    <p className="font-size--lg font--bold text--grey-200">
                        {data.height} cm
                    </p>
            ...
            <div className="goal-section">
                ...
                <div className="goal-wrapper flex align-items--center justify-content--between mb--20">
                    <div className="flex align-items--start">
                        ...
                        <div>
                            <p className="font--bold text--grey-200">
                                Weight Loss
                            </p>
                            <p className="font-size--xxs text--grey-200">
                                {data.goal.weightLoss} / 20 kg
                            </p>
                        </div>
                    </div>
                    <div>
                        <Space wrap>
                            <Progress
                                type="circle"
                                percent={(data.goal.weightLoss * 100) / 20}
                                size="small"
                            />
                        </Space>
                    </div>
                ...
                <div className="goal-wrapper-reading flex align-items--center justify-content--between mb--20">
                    <div className="flex align-items--start">
                        ...
                        <div>
                            ...
                            <p className="font-size--xxs text--grey-200">
                                {data.goal.reading} / 2 hr per day
                            </p>
                        </div>
                    </div>
                    <div>
                        <Space wrap>
                            <Progress
                                type="circle"
                                percent={(data.goal.reading * 100) / 2}
                                size="small"
                                strokeColor={"#999905"}
                            />
                        </Space>
            ...
            <div className="activity-section">
                <p className="text--grey-600 font--bold mb--15">
                    Your Activity
                </p>
                    ...
                    {activity.length > 0 &&
                        activity.map((activity, index) => {
                            if (index < 4) {
                                return (
                                    <div
                                        className="activity-info flex align-items--center justify-content--between mb--10 cursor--pointer"
                                        key={index}
                                        onClick={() =>
